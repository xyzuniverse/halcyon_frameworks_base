...
package com.android.internal.halcyon.notification;
...
public final class LineageBatteryLights {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.BATTERY_LIGHT_FULL_CHARGE_DISABLED), false, this,
                    UserHandle.USER_ALL);
            ...
            if (mCanAdjustBrightness) {
                ...
                resolver.registerContentObserver(Settings.System.getUriFor(
                        Settings.System.BATTERY_LIGHT_BRIGHTNESS_LEVEL), false, this,
                        UserHandle.USER_ALL);
                // Battery brightness level in Do Not Disturb mode
                resolver.registerContentObserver(Settings.System.getUriFor(
                        Settings.System.BATTERY_LIGHT_BRIGHTNESS_LEVEL_ZEN), false, this,
                        UserHandle.USER_ALL);
            }
        ...
        private void update() {
            ...
            if (mCanAdjustBrightness) {
                // Battery brightness level
                mBatteryBrightnessLevel = Settings.System.getIntForUser(resolver,
                        Settings.System.BATTERY_LIGHT_BRIGHTNESS_LEVEL,
                        LedValues.LIGHT_BRIGHTNESS_MAXIMUM, UserHandle.USER_CURRENT);
                // Battery brightness level in Do Not Disturb mode
                mBatteryBrightnessZenLevel = Settings.System.getIntForUser(resolver,
