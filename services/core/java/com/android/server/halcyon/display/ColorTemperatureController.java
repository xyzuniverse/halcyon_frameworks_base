 ...
 */
package com.android.server.halcyon.display;
...
import com.android.server.halcyon.display.TwilightTracker.TwilightState;

import java.io.PrintWriter;
import java.util.BitSet;

import com.android.internal.halcyon.hardware.LineageHardwareManager;
import com.android.internal.halcyon.hardware.LiveDisplayManager;
import com.android.internal.util.halcyon.ColorUtils;

import static com.android.internal.halcyon.hardware.LiveDisplayManager.MODE_AUTO;
import static com.android.internal.halcyon.hardware.LiveDisplayManager.MODE_DAY;
import static com.android.internal.halcyon.hardware.LiveDisplayManager.MODE_NIGHT;
...
public class ColorTemperatureController extends LiveDisplayFeature {
    ...
    public ColorTemperatureController(Context context,
        ...
        mColorBalanceCurve = com.android.internal.util.halcyon.MathUtils.powerCurve(
    ...
    private int mapColorTemperatureToBalance(int temperature) {
        double z = com.android.internal.util.halcyon.MathUtils.powerCurveToLinear(mColorBalanceCurve, temperature);
