...
import com.android.server.halcyon.ParallelSpaceManagerService;
...
public class PackageManagerService implements PackageSender, TestUtilityService {
    ...
    private final List<ComponentName> mDisabledComponentsList = new ArrayList<ComponentName>();
    ...
    public class IPackageManagerImpl extends IPackageManagerBase {
        ...
        public void setComponentEnabledSetting(ComponentName componentName,
            ...
            if (mDisabledComponentsList.contains(componentName)) {
                Slog.i(TAG, "Ignoring attempt to set enabled state of disabled component "
        ...
        public void setComponentEnabledSettings(
            ...
            final List<PackageManager.ComponentEnabledSetting> filteredSettings = settings.stream()
                .filter(setting -> {
                    return !mDisabledComponentsList.contains(setting.getComponentName());
                })
                .collect(Collectors.toList());
            setEnabledSettings(filteredSettings, userId, callingPackage);
        }
